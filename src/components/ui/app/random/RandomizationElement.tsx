...
export default function RandomizationElement({backgroundImage, name, uri, width, loading}: {backgroundImage:string, name: string, uri: string, width:number, loading:boolean}){
